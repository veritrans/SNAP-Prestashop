  ...
  <legend><img src="../img/admin/contact.gif" />Basic Information</legend>
    <table border="0" id="form">
      ...
      <!-- <tr>
        ...
        <td>
          <select name="MT_API_VERSION" id="midtransApiVersion">
      ...
      <input type="hidden" name="MT_API_VERSION" value="2">
      <!-- API VERSION -->

      <!-- <tr>
        <td width="300" style="vertical-align: top;">Payment Type</td>
        <td>
          <select name="MT_PAYMENT_TYPE" id="midtransPaymentType">
      ...
      <!-- <tr class="v1_vtweb_settings sensitive">
        ...
        <td><input type="text" name="MT_MERCHANT_ID" value="{$merchant_id}" style="width: 300px;" /></td>
      </tr> -->
      <!-- MERCHANT_ID -->

      <!-- <tr class="v1_vtweb_settings sensitive">
        <td width="300" style="vertical-align: top;">Merchant Hash</td>
        <td><input type="text" name="MT_MERCHANT_HASH" value="{$merchant_hash_key}" style="width: 300px;" /></td>
      </tr> -->
      <!-- MERCHANT_HASH -->

      <tr class="v1_vtdirect_settings v2_settings">
        <td width="300" style="vertical-align: top;">Client Key</td>
        <td><input type="text" name="MT_CLIENT_KEY" value="{$client_key}" style="width: 300px;" /></td>
      </tr>
      <!-- CLIENT_KEY -->

      <tr class="v1_vtdirect_settings v2_settings">
        <td width="300" style="vertical-align: top;">Server Key</td>
        <td><input type="text" name="MT_SERVER_KEY" value="{$server_key}" style="width: 300px;" /></td>
      </tr>
      <!-- SERVER_KEY -->
      ...
      <input type="hidden" name="MT_PAYMENT_TYPE" value="vtweb">
      <!-- PAYMENT_TYPE -->

      <tr>
        <td width="300" style="vertical-align: top;">Map Payment Success to Status:</td>
        <td>
          <select name="MT_PAYMENT_SUCCESS_STATUS_MAP">
      ...
      <tr>
        ...
        <td>
          <select name="MT_PAYMENT_CHALLENGE_STATUS_MAP">
            {foreach from=$statuses item=v}
      ...
      <tr>
        ...
        <td>
          <select name="MT_PAYMENT_FAILURE_STATUS_MAP">
            {foreach from=$statuses item=v}
      ...
      <tr>
        ...
        <td><input type="checkbox" name="MT_3D_SECURE" {if $enable_3d_secure}checked{/if} style="width: 300px;" /></td>
      </tr>
      <!-- 3D_SECURE -->
      
      <tr>
        <td width="300" style="vertical-align: top;">Enable Sanitization?</td>
        <td><input type="checkbox" name="MT_SANITIZED" {if $enable_sanitized}checked{/if} style="width: 300px;" /></td>
      </tr>
      <!-- Sanitized -->
      <tr>
      ...
      <tr>
        ...
        <td><input type="text" name="MT_KURS" value="{$kurs}" style="width: 300px;" /></td>
      </tr>
      <!-- KURS -->
...
<script>
  $(function() {
    function sensitiveOptions() {
      var api_version = $('#midtransApiVersion').val();
    ...
    $("#midtransApiVersion").on('change', function(e, data) {
      sensitiveOptions();
    });
