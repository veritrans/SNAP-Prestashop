...
<section id="main">
	...
	<section id="content" class="page-content page-cms">
		...
		{elseif $status == 'back'}
			<p>
				<b><h3 class="alert alert-info"> <i class="material-icons">schedule</i> {l s='We havent received your payment, please complete your payment' mod='midtranspay'}</h3></b>
			</p>
			<p class="warning">
		...
		{elseif $status == 'pending'}
			<p>
				<b><h3 class="alert alert-info"> <i class="material-icons">schedule</i> {l s='Awaiting your payment' mod='midtranspay'}</h3></b>
			</p>
			<p class="warning">
